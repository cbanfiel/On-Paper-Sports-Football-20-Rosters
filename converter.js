...
function generatedPlayerGenerationToTeamNFL(){


  for(let i=0; i<teams.length; i++){
    let team = teams[i];
    for(let j=0; j<playersForTeam.length; j++){
      let ovr = 65;
      let data = playersForTeam[j];
      let age = data.age;
...
function generatedPlayerGenerationToTeam(){
  ...
  for(let j=0; j<playersToGen.length; j++){
    ...
    if(data.position === "OLB"){
      position = 15;
    }
    if(data.position === "ILB"){
      position = 14;
    }
     if(data.position === "CB"){
      position = 16;
    ...
    else if(data.year === "SO"){
      age = 19;
    }
    else if(data.year === "JR"){
      age = 20;
    }
    else{
      age = 21;
